    ...
    [
        {
            ...
            description: "Giving is intentionally sharing your money to benefit others, without expecting anything in return. As a habit, it's not about the amount. It's about consistency and intention.",
            advantages: [
        ...
        },
        {
            ...
            description: "Planning as a money habit is about being intentional with your finances instead of reacting to them. It's one of the strongest habits because it affects every other money decision you make.",
            advantages: [
        ...
        },
        {
            ...
            description: "Security is the habit of protecting yourself from financial shocks so money problems don’t turn into life problems.It’s about stability, safety, and resilience, not wealth or luxury.",
            advantages: [
        ...
        },
        {
            ...
            description: "Status is how we use money to signal identity, success, or belonging to others.It’s spending (or saving) driven by how things look, how we compare to others, and how we want to be perceived.",
            advantages: [
        ...
        },
        {
            ...
            description: "Spontaneous is the money habit that feels good in the moment and quietly shapes your finances long-term. Being spontaneous with money means making decisions in the moment.",
            advantages: [
        ...
        },
        {
            ...
            description: "Being carefree with money is having a relaxed, confident attitude toward finances. It’s not about spending recklessly. It’s about not letting money stress dominate your life.",
            advantages: [
