...
export const HABITUDES: Habitude[] = [
    ...
    },
    {
        ...
        [
          ...
          "Resent when giving is expected andassumed.",
    ...
    },
    {
        ...
        [
            ...
            "Have money reserved to pay for the unexpected.",
            "Set and accomplish goals.",
            "Buy items you really want that will retainvalue.",
            "Have a sense of well-being and control."
        ],
        disadvantages: [
            "Feel pressured by others to spend money on things that do not fit your budget or values.",
    ...
    },
    {
        ...
        [
            ...
            "Unable to support yourself if the person(s) providing for you cannot continue orchooses to stop.",
    ...
    },
    {
        ...
        scoreContent: {
          missing: { 
            forYou: "For you, Security is an unused Habitude. This indicates it isn't your priority right now.", 
            cardBody: "None currently" 
          },
          low: { 
            forYou: "You are using the Security Habitude in moderation.", 
            cardBody: "None currently" 
          },
          medium: { 
            forYou: "None currently", 
            cardBody: "None currently" 
          },
          high: { 
            forYou: "None currently", 
    ...
    },
    {
        ...
        [
            ...
            "Spend money unwisely to maintainappearances.",
